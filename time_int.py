...
class time_integration:
    def __init__(self, linedg):
        ...
        if (linedg.params.Limiter() == "mood"):
            self.__limit = Limit.LimitMOOD(linedg)
        else:
